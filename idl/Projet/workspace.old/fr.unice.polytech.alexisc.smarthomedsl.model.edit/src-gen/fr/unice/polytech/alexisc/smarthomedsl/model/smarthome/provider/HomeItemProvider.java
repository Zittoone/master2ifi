/**
 */
package fr.unice.polytech.alexisc.smarthomedsl.model.smarthome.provider;
...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.alexisc.smarthomedsl.model.smarthome.Home} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HomeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPlacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Home_places_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Home_places_feature", "_UI_Home_type"),
						SmarthomePackage.Literals.HOME__PLACES, true, false, true, null, null, null));
	}
	...
	protected void addScenariosPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Home_scenarios_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Home_scenarios_feature", "_UI_Home_type"),
						SmarthomePackage.Literals.HOME__SCENARIOS, true, false, true, null, null, null));
	}
