 ...
 * </p>
 * <ul>
 *   <li>{@link fr.unice.polytech.alexisc.smarthomedsl.model.model.impl.RoomImpl#getSensors <em>Sensors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomImpl extends NamedEntityImpl implements Room {
	...
	public EList<Sensor> getSensors() {
		if (sensors == null) {
			sensors = new EObjectContainmentEList<Sensor>(Sensor.class, this, ModelPackage.ROOM__SENSORS);
		}
		return sensors;
	}
