...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.alexisc.smarthomedsl.model.model.PersonPredicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonPredicateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonPredicate_person_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonPredicate_person_feature", "_UI_PersonPredicate_type"),
				 ModelPackage.Literals.PERSON_PREDICATE__PERSON,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActivityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonPredicate_activity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonPredicate_activity_feature", "_UI_PersonPredicate_type"),
				 ModelPackage.Literals.PERSON_PREDICATE__ACTIVITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PersonPredicate_type") :
