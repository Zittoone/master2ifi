...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.alexisc.smarthomedsl.model.model.Pattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternItemProvider extends NamedEntityItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.PATTERN__PREDICATES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Pattern.class)) {
			case ModelPackage.PATTERN__PREDICATES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.PATTERN__PREDICATES,
				 ModelFactory.eINSTANCE.createRule()));
	}
