...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.alexisc.smarthomedsl.model.model.Duration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duration_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duration_duration_feature", "_UI_Duration_type"),
				 ModelPackage.Literals.DURATION__DURATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.DURATION__PRECISION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Duration_type") + " " + duration.getDuration();
	}
