...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.alexisc.smarthomedsl.model.model.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_duration_feature", "_UI_Rule_type"),
				 ModelPackage.Literals.RULE__DURATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPredicatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_predicate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_predicate_feature", "_UI_Rule_type"),
				 ModelPackage.Literals.RULE__PREDICATE,
				 true,
				 false,
				 true,
				 null,
