...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.alexisc.smarthomedsl.model.model.Predicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PredicateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Predicate_sensor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Predicate_sensor_feature", "_UI_Predicate_type"),
				 ModelPackage.Literals.PREDICATE__SENSOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Predicate_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Predicate_value_feature", "_UI_Predicate_type"),
				 ModelPackage.Literals.PREDICATE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Predicate_type") + " " + predicate.getValue();
	}
