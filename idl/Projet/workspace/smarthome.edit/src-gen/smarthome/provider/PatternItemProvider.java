	...
	protected void addRulesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Pattern_rules_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Pattern_rules_feature",
								"_UI_Pattern_type"),
						SmarthomePackage.Literals.PATTERN__RULES, true, false, true, null, null, null));
	}
