...
public class SmarthomePackageImpl extends EPackageImpl implements SmarthomePackage {
	...
	public static SmarthomePackage init() {
		...
		SmarthomePackageImpl theSmarthomePackage = (SmarthomePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof SmarthomePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
